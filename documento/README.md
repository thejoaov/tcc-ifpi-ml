...
- `output`: Artefatos gerados localmente (`documento.pdf` e `documento.docx`);
...
- `texto-base.md`: Rascunho-base em Markdown usado como apoio na redação/migração para o LaTeX.

O arquivo principal do projeto é o `documento.tex`, na pasta raiz. **Compile este arquivo e seu trabalho estará pronto**!

Para este repositório, o fluxo recomendado é:
...
Isso gera os artefatos em `documento/output/`.
