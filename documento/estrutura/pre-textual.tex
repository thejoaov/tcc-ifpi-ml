...
\cleardoublepage
%% Título centralizado, padronizado com as demais listas pré-textuais
%% (via \InputIfFileExists para não quebrar a conversão DOCX no pandoc)
\begingroup
\InputIfFileExists{configuracoes/titulo-centralizado.tex}{}{}
