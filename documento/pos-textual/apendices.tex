...
%% Inclui o rótulo "APÊNDICE A --" antes do título
\titleformat{\chapter}
{\normalfont\normalsize\bfseries\MakeUppercase}{Apêndice \thechapter\ --}{1em}{\vspace{1em}}{}
...
\texttt{possui\_computador} & Categórico (binário) & Disponibilidade de computador para os estudos (\textit{proxy} da exclusão digital qualitativa). \\
...
\texttt{situacao} & Categórico (alvo) & Tendência de desempenho projetada para o final do ano letivo, rotulada pelos critérios da LDB: \textit{Aprovado}, \textit{Em Risco} ou \textit{Reprovado}. \\
\bottomrule
\end{tabular}
