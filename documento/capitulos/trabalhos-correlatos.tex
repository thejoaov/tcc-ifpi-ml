...
\citeonline{costa2012} & \textit{Naive Bayes}, \textit{Decision Tree} & Notas de avaliações contínuas, frequência, dados demográficos & Adota a formulação de métricas de engajamento e a classificação multiclasse do rendimento discente. \\
